...
v0.1.12 有七个质量择优后的可执行工具。它们处理机械载体、检索、复现或 QA，不拥有 Coach 的阶段/时间/提交决策权。
...
| Reproducibility | feature-scoped dependency doctor, run manifest v3 create/verify/replay, semantic fingerprint, provenance bundle/verify-bundle |
