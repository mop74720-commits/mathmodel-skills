...
8. 预先划分 main text / appendix / support：完整 Run、审计、复现环境、AI 详情和大段代码不因“仓库里存在”就进入正文；服从 `references/paper-quality-contract.md`。
9. 为每问设计快速定位点：标题附近或结果小结中应能找到直接答案，避免读者必须穿过整段算法说明才能知道结论。
